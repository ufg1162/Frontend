...
function MenuBar({ setShowLog, setShowEdit, setShowData, setEditprofileDisplay, user, setShowAdmin, admin, userImage  }) {
    ...
    return (
        <div id="Menu-container">
            ...
            <img className="menu-profile" src={userImage || user.image || "http://res.cloudinary.com/natialemu47/image/upload/v1652196653/dnt17uj4nl9ywfq648v8.jpg"} onClick={EditProfileShown} alt="profile-img"></img>
        </div>
    )
}
